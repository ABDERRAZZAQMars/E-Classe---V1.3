        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                '<tr style="background-color: white;">
                    ...
                    <td style="vertical-align: middle;"><a href="editcourses .php?edit='.$row["id"].'"><img src="./Icones/modifier.svg" alt=""></a></td>
                    <td style="vertical-align: middle;"><a href="deletecourses.php?delete='.$row["id"].'"><img src="./Icones/supprimer.svg" alt=""></a></td>
                </tr>';
            }
        } else {
            echo "0 results";
